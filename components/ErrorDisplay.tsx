...
export const ErrorDisplay: React.FC<ErrorDisplayProps> = ({ error, onDismiss }) => {
    ...
    return (
        <div className="bg-red-500/10 dark:bg-red-900/20 border-l-4 border-red-500 dark:border-red-500 p-4 rounded-r-lg" role="alert">
            <div className="flex items-start">
                ...
                <div className="ml-auto pl-3">
                    <Tooltip text="Fechar esta notificação de erro.">
                        <button onClick={onDismiss} aria-label="Fechar notificação de erro" className="p-1 -mt-1 -mr-1 rounded-full text-red-500 dark:text-red-400 hover:bg-red-200/50 dark:hover:bg-red-800/50 focus:outline-none focus:ring-2 focus:ring-red-500">
            ...
            {hasDetails && isDetailsOpen && (
                <div className="mt-4">
                    <pre className="bg-red-200/30 dark:bg-slate-900/50 text-red-900 dark:text-red-200 text-xs p-3 rounded-md overflow-x-auto">
